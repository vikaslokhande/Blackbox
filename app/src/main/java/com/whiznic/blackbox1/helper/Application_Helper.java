...
public class Application_Helper {
	...
	public Application_Helper(Context context) {
	...
	public Dialog showProgressDialog(Activity activity, boolean isCancelable) 
	{
		...
		pg.setIndeterminateDrawable(mContext.getResources().getDrawable(
                drawable.loading_progress_bar));
		pgbar.addContentView(pg, new LayoutParams(
