...
public class LoggingService extends IntentService{
	...
	public static final String LOG_TAG = "TrackerOn";
	public static final String ACTION_LOG = "TrackerOn.LOG";
	public static final String ACTION_CLEAR_LOGS = "TrackerOn.CLEAR_LOGS";
	public static final String EXTRA_LOG_PRIORITY ="log_priority";
	public static final String EXTRA_LOG_MESSAGE = "log_message";
	public static final String LOG_FILE = "gcm-TrackerOn.log";
	...
	protected void onHandleIntent(Intent intent) 
	{
		...
		if(intent.getAction().equals(ACTION_LOG)) {
			doLog(intent);
		} else if(intent.getAction().equals(ACTION_CLEAR_LOGS)){
			doClear();
		} else 
    ...
    private void doLog (Intent intent) 
    {
		...
		//forward the log to local broadcast subscribers (ie UI)
