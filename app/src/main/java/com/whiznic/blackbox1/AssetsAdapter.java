...
public class AssetsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_checked, null);
        }
        AssetsHelper helper = getItem(position);
        Log.d("Evotrack getView", helper.assetName + " -- " + helper.isChecked);
        CheckBox textView =(CheckBox) convertView.findViewById(R.id.item);
        textView.setText(helper.assetName);
        textView.setChecked(helper.isChecked);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("evotrack", helper.assetName + " -- " + helper.isChecked);
            }
        });
